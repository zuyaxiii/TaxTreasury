...
const PaymentSharesSelector: React.FC<PaymentSharesSelectorProps> = ({
  ...
  const feeTypes = [
    ...
    { key: "mortgageFee", label: "ค่าจดจำนอง", isFixed: true }, 
  ];
                  ...
                  {feeType.isFixed ? (
                    <div className="flex items-center">
                      <input
                        ...
                        value="buyer"
                        checked={
                          paymentShares[feeType.key as keyof PaymentShares] === "buyer"
                        }
                    ...
                    <>
                      <div className="flex items-center">
                        <input
                          ...
                          value="50-50"
                          checked={
                            paymentShares[feeType.key as keyof PaymentShares] === "50-50"
                          }
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          value="seller"
                          checked={
                            paymentShares[feeType.key as keyof PaymentShares] === "seller"
                          }
